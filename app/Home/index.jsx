...
export function Home() {
    ...
    return (
        <ContainerBody>
            ...
            <ContainerTop>
                <Banner>
                    <video src='../../public/videoBanner.mp4' preload="none" autoPlay muted loop></video>
                    <Mask />
                    <div className="containerBanner">
                        <ContentLeft>
                            <Image src='../../public/logo.svg' alt='Logo da Empresa' />
                            <FirstDescription>
            ...
            <ContainerMain>
                <ContainerAbout>
                    ...
                    <div className="aboutImage">
                        <Image src='../../public/desenvolvedor.jpg' alt='Desenvolvedor-de-sites' />
                ...
                <ContainerPortfolio>
                    <video src='../../public/videoPortfolio.mp4' preload="none" autoPlay muted loop></video>
                    <Mask />
